  ...
  <div class="body">
    ...
    <div class="dialog">
      <table>
        ...
        <tr class="prop">
          <td valign="top" class="name"><g:message code="booking.appearanceTime.label" default="Appearance Time" /></td>

         <td valign="top" class="value"><turfclub:formatTime date="${bookingInstance.appearanceTime}" /></td>
