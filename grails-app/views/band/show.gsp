  ...
  <div class="body">
    ...
    <div class="buttons">
      <g:form>
        ...
        <span class="button"><g:actionSubmit class="delete" action="delete" value="${message(code: 'band.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'band.button.delete.confirm.message', default: 'Are you sure?')}');" /></span>
      </g:form>
    </div>
  </div>
</body>
